...
Este proyecto es un **análisis completo de datos de telecomunicaciones** realizado para ayudar a **Telecom X** a entender y reducir la fuga de clientes (*churn*): el fenómeno en el que los usuarios cancelan su contrato y dejan de usar el servicio.
...
> *Nuevo cliente, con contrato mensual, que paga caro, vive solo, revisa su factura por correo electrónico y paga con cheque electrónico.*
